...
var MENU_ID = 'spamMenu';

var addDropDownMenu = function addDropDownMenu(parentElem) {
...
var toggleMenu = function toggleMenu() {
  ...
  var classList = [].concat(_toConsumableArray(menu.classList));
  classList[classList.length - 1] = classList[classList.length - 1] === 'hidden' ? 'rofl' : 'hidden';
  menu.className = classList.join(' ');
};

var addSpamButton = function addSpamButton(chatButtons) {
  return createElement('a', { className: chatButtons.children[0].className,
...
var onDomReady = function onDomReady(chatButtons) {
  addDropDownMenu(chatButtons.parentElement);
  var button = addSpamButton(chatButtons);
  chatButtons.appendChild(button);
  (0, _menu2['default'])(MENU_ID, button);
};

var waitChatLoad = setInterval(function () {
...
},{"../menu":7}],6:[function(require,module,exports){
'use strict';
...
var SpamStorage = {
  ...
  getData: function getData(key, defaultVal) {

    return _q2['default'].promise(function (success, reject) {
      _chromeApiStorage2['default'].get(key, function (data) {
        if (defaultVal && !data) {
          data = defaultVal;
        }
        success(data);
  ...
  add: function add(newSpam) {
    return _q2['default'].promise(function (success, reject) {
      SpamStorage.list().then(function (spams) {
        var newId = spams.length > 0 ? spams[spams.length - 1].id + 1 : 0;
        spams.push({
          id: newId,
          text: newSpam
        });
        _chromeApiStorage2['default'].set(_defineProperty({}, KEYS.SPAMS, spams), success);
      });
    });
  },
  ...
  remove: function remove(idToRemove) {
    return _q2['default'].promise(function (success, reject) {
      SpamStorage.list().then(function (spams) {
        spams = spams.filter(function (_ref) {
          var id = _ref.id;
  ...
  update: function update(id, newSpam) {
    return _q2['default'].promise(function (success, reject) {
      SpamStorage.list().then(function (spams) {
        spams = spams.map(function (spam) {
          if (spam.id === id) {
            spam.text = newSpam;
          }
          return spam;
  ...
  onChange: function onChange() {
    return _q2['default'].promise(function (success, reject) {
      _chromeApiStorage2['default'].onChange(success);
    });
  }

};

exports['default'] = SpamStorage;
module.exports = exports['default'];

},{"../chrome-api/storage":4,"q":2}],7:[function(require,module,exports){
'use strict';
...
var _helpersSpamStorage = require('./helpers/spamStorage');
...
var dropMenu = _vue2['default'].extend({
  ...
  methods: {
    ...
    syncList: function syncList() {
      var _this = this;

      _helpersSpamStorage2['default'].list().then(function (spams) {
        return _this.spams = spams;
      });
    },
...
_vue2['default'].component('drop-menu', dropMenu);

var createComponent = function createComponent(id, elem) {
  var component = new _vue2['default']({ el: '#' + id });
